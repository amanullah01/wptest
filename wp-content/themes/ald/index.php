	...
	<div class="container">
		<div class="row">
			<div id="fh5co-section">
				...
				<div class="col-forth fh5co-video fh5co-bg" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/image_1.jpg)">
						...
						<div class="row">
							<div class="col-md-7 col-sm-7 col-md-pull-2 col-sm-pull-2 animate-box" data-animate-effect="fadeInRight">
								<div class="feature-image">
									<img src="<?php echo get_template_directory_uri(); ?>/images/work_1.png" alt="work">
								</div>
							</div>
			...
			<div class="row">
				<div class="project">
					<div class="col-md-8 col-md-push-5 animate-box" data-animate-effect="fadeInLeft">
						<img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/images/work_1.png" alt="work">
					</div>
